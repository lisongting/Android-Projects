...
import com.paperfish.aicameratest2.Classifier.Recognition;
...
public class BoundingBoxView extends View {
    ...
    public void onDraw(final Canvas canvas) {
        ...
        Log.i("tag", "view_size:" + view_width_temp + " x " + view_height_temp);
        ...
        Log.i("tag", "inputSize:" + INPUT_SIZE);
        ...
        if (results != null) {
            for (final Recognition recog : results) {
                ...
                Log.i("tag", "Recognition Result:" + recog.getTitle());
                Log.i("tag", "Location:[" + bounding_x+","+bounding_y+","+ bounding_x2+","+ bounding_y2+"]");
