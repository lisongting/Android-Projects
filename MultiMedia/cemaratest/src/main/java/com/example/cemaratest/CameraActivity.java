...
public class CameraActivity  extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tv_shot = (TextView) findViewById(R.id.id_bt_oval);
        ...
        bt_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(CameraActivity.this, faceBitmap.getRowBytes(), Toast.LENGTH_SHORT).show();
                Log.i("tag",faceBitmap.getRowBytes()+"|"+faceBitmap.getDensity()+"");
            }
        });
