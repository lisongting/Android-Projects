...
package com.example.rostest.ros.rosbridge;


import com.example.rostest.ros.ROSClient;
import com.example.rostest.ros.Service;
import com.example.rostest.ros.message.Message;
import com.example.rostest.ros.message.MessageType;
import com.example.rostest.ros.rosapi.message.Empty;
import com.example.rostest.ros.rosapi.message.MessageDetails;
import com.example.rostest.ros.rosapi.message.Nodes;
import com.example.rostest.ros.rosapi.message.Services;
import com.example.rostest.ros.rosapi.message.Topic;
import com.example.rostest.ros.rosapi.message.Topics;
import com.example.rostest.ros.rosapi.message.Type;
import com.example.rostest.ros.rosapi.message.TypeDef;
import com.example.rostest.ros.rosbridge.implementation.ROSBridgeWebSocketClient;
import com.example.rostest.ros.rosbridge.operation.Operation;
...
public class ROSBridgeClient extends ROSClient {
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<com.example.rostest.ros.rosapi.message.Service, Type> serviceTypeService =
                new Service<com.example.rostest.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                        com.example.rostest.ros.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new com.example.rostest.ros.rosapi.message.Service(service)).type;
    }
