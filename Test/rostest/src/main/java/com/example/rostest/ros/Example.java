 ...
 * 
 */
package com.example.rostest.ros;


import com.example.rostest.ros.message.Clock;
import com.example.rostest.ros.message.Log;
import com.example.rostest.ros.rosapi.message.Empty;
import com.example.rostest.ros.rosapi.message.GetTime;
...
public class Example {
        ...
        try {
            ...
            Service<com.example.rostest.ros.rosapi.message.Service, Type> serviceTypeService =
                    new Service<com.example.rostest.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                        com.example.rostest.ros.rosapi.message.Service.class, Type.class, client);
            serviceTypeService.verify();
            String type = serviceTypeService.callBlocking(
                    new com.example.rostest.ros.rosapi.message.Service("/rosapi/service_response_details")).type;
            ...
            com.example.rostest.ros.Topic<Log> logTopic =
                    new com.example.rostest.ros.Topic<Log>("/rosout", Log.class, client);
            logTopic.verify();
    ...
    public static void testTopic(ROSBridgeClient client) {
        com.example.rostest.ros.Topic<Clock> clockTopic = new com.example.rostest.ros.Topic<Clock>("/clock", Clock.class, client);
