...
public class Graphics {
    ...
    public static void drawLine(Canvas canvas, float startX,
                                float startY, float endY, Paint paint) {
        paint.setStyle(Paint.Style.STROKE);
        canvas.drawLine(startX, startY, endX, endY, paint);
    }

    public static void drawRect(Canvas canvas, float x, float y,
    ...
    public static void drawBorderString(Canvas c, int borderColor,
                                        ...
                                        int x, int y, int borderWidth, Paint mPaint)
    {
    ...
    public synchronized static void drawMatrixImage(Canvas canvas, Bitmap src,
                                                    int srcX, int srcY, int width,
                                                    int height, int trans, int drawX,
    ...
    public static Bitmap scale(Bitmap img, float newWidth, float newHeight)
    {
        ...
        Log.i("tag","Graphics的scale()函数。createBitmap()之前：width:"+width+"  height:"+height);
        try
        {
            // 生成对img缩放之后的图片
