...
import cn.ssdut.lst.roslib.message.Clock;
import cn.ssdut.lst.roslib.rosapi.message.Empty;
import cn.ssdut.lst.roslib.rosapi.message.GetTime;
import cn.ssdut.lst.roslib.rosapi.message.MessageDetails;
import cn.ssdut.lst.roslib.rosapi.message.Type;
import cn.ssdut.lst.roslib.rosbridge.ROSBridgeClient;
...
public class Example {
    ...
    public static void testService(ROSBridgeClient client) {
        try {
            ...
            Service<cn.ssdut.lst.roslib.Service, Type> serviceTypeService =
                    new Service<cn.ssdut.lst.roslib.rosapi.message.Service, Type>("/rosapi/service_type",
